...
function (a)
{
	...
	t.prototype._selectOptionsFromConfig = function ()
	{
		...
		if (t)
		{
			switch (a("input[type=checkbox]").prop("checked", !1), t.sideBarTheme)
			{
				case "default":
...
function (a)
{
	...
	}, t.prototype.activateDarkMode = function ()
	{
		...
		}, 500), a.LeftSidebar.activateDarkTheme(), this._saveConfig(
		{
			isDarkModeEnabled: !0,
			sideBarTheme: i
		})
...
function (a)
{
	...
	}, t.prototype.init = function ()
	{
		...
		document.getElementById("light-style").href.includes("rtl.min.html") && (document.getElementsByTagName("html")[0].dir = "rtl"), document.getElementById("dark-style").href.includes("rtl.min.html") && (document.getElementsByTagName("html")[0].dir = "rtl")
